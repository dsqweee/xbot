...
//        public bool _CanceledAfterClick { get; } 
//        public T Component { get; set; }
//        private TaskCompletionSource<T> _interactionCompletionSource;
//        private CancellationTokenSource _cancellationTokenSource;

//        public ComponentEvent(HashSet<string> GuidId = null, bool CanceledAfterClick = true)
//        {
//            if (GuidId == null)
//                GuidId = new HashSet<string>();

//            _CanceledAfterClick = CanceledAfterClick;
//            _GuidId = GuidId;
